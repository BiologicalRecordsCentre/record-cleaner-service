...
class TestWgs84:
    ...
    def test_okay_britain(self):
        ...
        sref = Sref(
            latitude=54, longitude=-2, srid=SrefSystem.WGS84, accuracy=1000)
        g = Wgs84(sref)
    ...
    def test_okay_ireland(self):
        ...
        sref = Sref(
            latitude=53, longitude=-8, srid=SrefSystem.WGS84, accuracy=1000)
        g = Wgs84(sref)
    ...
    def test_okay_channel_islands(self):
        ...
        sref = Sref(
            latitude=49.5, longitude=-2.5, srid=SrefSystem.WGS84, accuracy=1000
        )
        g = Wgs84(sref)
